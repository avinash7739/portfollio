    ...
    return (
        <section id="education" className="py-20 bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-gray-950 dark:via-black dark:to-gray-950 text-black dark:text-white transition-colors duration-300 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 sm:px-6 max-w-6xl relative z-10">
                ...
                <div className="flex flex-col mb-12 sm:mb-16 md:pl-4">
                    <div className="flex items-center gap-4 mb-2">
                        {/* The white dot next to Education with pulse animation */}
                        <div className="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-blue-500 animate-pulse hidden md:block shadow-[0_0_10px_rgba(59,130,246,0.8)]"></div>
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight">
                            Education
                        </h2>
                    </div>
                    <p className="text-base sm:text-lg text-gray-600 dark:text-gray-400 md:pl-7">
                        My academic background
                    </p>
                </div>

                {/* Education Cards Grid */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 md:pl-4">
                    {educations.map((edu) => (
                        <div
                            key={edu.id}
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                <h3 className="text-xl sm:text-2xl font-bold mb-2 text-gray-900 dark:text-white group-hover:text-blue-500 dark:group-hover:text-blue-400 transition-colors duration-300">
                                    {edu.degree}
                                </h3>
                                <h4 className="text-sm sm:text-md font-medium text-gray-700 dark:text-gray-300 mb-6 sm:mb-8 pb-3 sm:pb-4 border-b border-gray-100 dark:border-gray-800/80 transition-colors duration-300 group-hover:border-blue-500/30">
                                    {edu.institution}
                                </h4>
                            </div>

                            <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-gray-600 dark:text-gray-400 relative z-10">
